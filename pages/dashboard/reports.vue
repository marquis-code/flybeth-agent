<template>
  <div class="space-y-12">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4 border-b border-gray-100">
      <div class="space-y-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      <BaseCard v-for="report in summaryReports" :key="report.title" hover :padding="false" class="border border-gray-100 shadow-sm relative overflow-hidden group">
        <div class="p-10 relative z-10">
          <div class="flex items-center justify-between mb-8">
            <div class="p-5 bg-white border border-gray-100 shadow-sm rounded-[1.5rem] transition-all duration-500 group-hover:scale-110 group-hover:rotate-6" :class="report.iconColor">
    ...
    <BaseCard :padding="false" class="border border-gray-100 shadow-sm overflow-hidden">
      <div class="p-10 bg-white border-b border-gray-50 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2 bg-gray-50 p-1 rounded-2xl border border-gray-100">
      ...
      <div class="p-10">
        <div class="h-80 bg-gray-50/50 rounded-[2.5rem] flex items-center justify-center border-4 border-dashed border-gray-100 group relative cursor-pointer overflow-hidden">
          ...
          <div class="text-center relative z-10 transition-transform duration-500 group-hover:-translate-y-2">
            <div class="p-8 bg-white border border-gray-100 shadow-sm rounded-[2.5rem] inline-block mb-6 group-hover:scale-110 transition-transform">
