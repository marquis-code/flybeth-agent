      ...
      <div class="max-w-4xl mx-auto px-6 lg:px-10 space-y-16">
        <div class="text-center space-y-6">
          <h1 class="text-5xl lg:text-7xl  text-primary-dark er leading-tight">
             System <br />
             <span class="text-secondary ">vitality.</span>
          </h1>
        ...
        <div class="bg-neutral-50 rounded-[3rem] p-10 border border-neutral-100 shadow-sm relative overflow-hidden group">
           <div class="flex flex-col md:flex-row items-center justify-between gap-8 border-b border-neutral-200 pb-10">
              <div class="space-y-1 text-center md:text-left">
                 <p class="text-sm  text-neutral-400  ">Global Network</p>
                 <h2 class="text-4xl  text-green-600">All systems go</h2>
              </div>
              <div class="px-6 py-2 bg-green-50 text-green-700 rounded-full text-xs   border border-green-200 ">
                 Stable
              </div>
           </div>
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-12 pt-10">
              <div v-for="node in nodes" :key="node.name" class="flex items-center justify-between p-4 bg-white rounded-2xl border border-neutral-100">
                 ...
                 <span class="text-[10px]  text-neutral-400  ">{{ node.latency }}ms</span>
              </div>
           </div>
        </div>
        ...
        <!-- Historical Uptime -->
        <div class="space-y-6">
           <h3 class="text-2xl  text-primary-dark ">Node health history</h3>
           <div class="space-y-4">
