<template>
  <div class="flex justify-between gap-2 sm:gap-3" @paste="handlePaste">
    <input
      ...
      class="w-12 h-16 text-center text-sm sm:text-lg  text-primary-dark bg-white border-2 border-gray-300 focus:border-secondary focus:ring-8 focus:ring-secondary/5 rounded-xl outline-none transition-all shadow-sm"
